 ...
 *              user accounts, including creating, updating, 
 *              deactivating, reactivating, and retrieving users. 
 *              It leverages UserService for communication with MongoDB.
 * Author: Saara M.K.F
 * Date Created: 03-10-2024
 * Notes: This controller supports user account management, including:
 *        - User sign-up and login.
 *        - Admin approval and rejection of user registration.
 *        - CRUD operations for user accounts.
 *        - Account deactivation and reactivation.
 *        Ensure that proper authorization is applied to sensitive 
 *        operations like updating, deactivating, or reactivating accounts.
 ***************************************************************/
