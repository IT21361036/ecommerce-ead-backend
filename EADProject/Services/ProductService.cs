 ...
 * Description: Provides the service layer for managing product-related 
 *              operations including creation, updating, deletion, 
 *              stock management, and retrieval from the MongoDB 
 *              database. Supports category validation and vendor 
 *              notifications for low stock.
 * Author: Saara M.K,F
 * Date Created: 30-09-2024
 * Notes: This class integrates with MongoDB collections for products, 
 *        categories, and users, and includes low stock alerts for 
 *        vendors via the VendorNotificationService.
 ***************************************************************/
